...
describe('LikeCommentary Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'like-commentary', component: LikeCommentaryComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.likeCommentaries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to likeCommentaryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLikeCommentaryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLikeCommentaryIdentifier).toHaveBeenCalledWith(entity);
