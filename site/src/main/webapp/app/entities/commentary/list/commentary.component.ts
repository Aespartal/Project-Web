...
import { EntityArrayResponseType, CommentaryService } from '../service/commentary.service';
...
export class CommentaryComponent implements OnInit {
  ...
  trackId = (_index: number, item: ICommentary): number => this.commentaryService.getCommentaryIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.commentaries = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ICommentary[] | null): ICommentary[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.commentaryService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
