...
describe('Commentary Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'commentary', component: CommentaryComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.commentaries?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to commentaryService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCommentaryIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCommentaryIdentifier).toHaveBeenCalledWith(entity);
